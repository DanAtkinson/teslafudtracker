...
fudwords = / desperate | rattle| worried |[En]ron|mental health|[Bb]lack[Rr]ock|([Bb]ig|in) [Tt]rouble|[Cc]louds [Gg]ather| fear| drugs |(little|no) chance of success| scare |poorly (built|engineered)|[Ss]uppliers.*[Rr]isk|[Dd]elivered with [Ff]laws|total fraud|grueling|[Ff]ormer employee|([Ff]ormer|[Ee]x[- ])[Tt]esla| (doom|doomed) |bankrupt|[pP]roblems [rR]aising [Cc]apital|cash (problem|crunch)|Tesla insider|lose money|losing (faith|confidence)|(serious|growing|raising|raised) concerns|xperts doubt|nalysts warn|scrambling/
